...
with sr.Microphone() as source:
    ...
    try:
        ...
        elif  text==" check internet speed " or text=="display innternet speed" or text=='internet speed' or text=='speed test' or text=='show internet speed' or text=="what's the internet speed":
            speedtest()
